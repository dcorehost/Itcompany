...
export default function WhyChooseUsWeb() {
  const points = [
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {points.map((item, index) => (
            <motion.div
              ...
              className="relative bg-white rounded-2xl shadow-lg p-8 group transition overflow-hidden hover:shadow-2xl cursor-pointer"
            >
