...
//                 <a href="/wordpress-development" className="block px-4 py-2 hover:bg-gray-100 text-gray-800">WordPress Development</a>
...
//               <a href="/wordpress-development" className="block text-gray-700">WordPress Development</a>
