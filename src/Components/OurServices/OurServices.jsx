...
const OurServices = () => {
  return (
    <section className="bg-gray-50 py-20 px-6 max-w-7xl mx-auto text-center">
      <h2 className="text-5xl font-extrabold mb-16 animate-text-slide">
        <span className="text-[#e53935] bg-gradient-to-r from-[#e53935] via-red-600 to-[#ff6659] bg-clip-text text-transparent">
          Our
        </span>{" "}
